...
import org.coiol.platform.core.util.ConvertUtils;
import org.coiol.platform.core.util.FileUtils;
...
public abstract class AbstractSequenceService   implements SequenceService{
    protected final PlatFormLogger LOG = PlatFormLoggerFactory.getPlatFormLogger(getClass());
    /**
     * 对一段String生成MD5摘要信息
