...
public class EncryptClassUtils {
    private static final PlatFormLogger LOG = PlatFormLoggerFactory.getPlatFormLogger(EncryptClassUtils.class);
    ...
    private static final String workDir="E:/Workspaces/MyEclipse 8.5/Platform/";
    static{        
