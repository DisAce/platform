!function (e, t) {
    var a = function (t, a) {
        function i(e) {
            ...
            a = t[c],
            i = v ? e.pageY : e.pageX;
            i > a + z ? (z = i - a - A + E, z > j && (z = j))  : (z = i - a - E, 0 > z && (z = 0)),
            o.update_scroll()
        }
        function n(t) {
            t.preventDefault(),
        ...
        this.reset = function () {
            if (!g) {
                ...
                v || _.children(0).css(d, this.size),
                _.css(u, this.size),
                e > t ? (m = !0, y.css(d, t).show(), T = parseFloat((t / e).toFixed(5)), A = parseInt(Math.round(t * T)), E = parseInt(Math.round(A / 2)), j = t - A, z = parseInt(Math.round(w[f] * T)), $[d] = A + 'px', $[c] = z + 'px', this.$element.addClass('scroll-active'), I || (l.reset && (w[f] = 0, $[c] = 0), I = !0))  : (m = !1, y.hide(), this.$element.removeClass('scroll-active'), _.css(u, ''))
            }
        },
...
function (e, t) {
    var a = function (t, a) {
        var i = e.extend({
        }, e.fn.ace_colorpicker.defaults, a),
        n = e(t),
        s = '',
        r = '',
        o = null,
...
function (e, t) {
    ...
    r = function (t, a) {
        ...
        }, e.fn.ace_file_input.defaults, a),
        this.$element = e(t),
        this.element = t,
        this.disabled = !1,
        this.can_reset = !0,
    ...
    var o = function () {
        ...
        t.off('dragenter').on('dragenter', function (e) {
            ...
            if (t.preventDefault(), t.stopPropagation(), !e.disabled) {
                ...
                i === !1 ? !1 : (e.$element.data('ace_input_method', 'drop'), e.$element.data('ace_input_files', i), e.show_file_list(i), e.$element.triggerHandler('change', [
                    !0
                ]), !0)
            }
        })
    ...
    d = function (t, a) {
        ...
        i = i > 0 ? i : e(t).width(),
        n = n > 0 ? n : e(t).height(),
        (i > a || n > a) && (i > n ? (n = parseInt(a / i * n), i = a)  : (i = parseInt(a / n * i), n = a));
        var s;
        try {
    ...
    p = function (t, a) {
        ...
        for (var c = [
            ...
            var p = t[u],
            v = s ? p.name : p;
            if (!i || i.test(v)) if (n && n.test(v)) 'ext' in d || (d.ext = [
            ]),
            d.ext.push(v);
             else {
                var g;
...
!function (e) {
    ...
    t.prototype = {
        ...
        sorter: function (e) {
            ...
            ]; t = e.shift(); ) t.toLowerCase().indexOf(this.query.toLowerCase()) ? ~t.indexOf(this.query) ? i.push(t)  : n.push(t)  : a.push(t);
            return a.concat(i, n)
        },
    ...
    e.fn.ace_wysiwyg = function (t) {
        ...
        return this.each(function () {
            ...
            for (var i in s) if (s.hasOwnProperty(i)) {
                ...
                if ('string' == typeof r && r in n) r = n[r],
                r.name = s[i];
                 else {
...
function (e, t) {
    ...
    e.fn.ace_spinner = function (i, n) {
        ...
        r = this.each(function () {
            ...
            o = 'object' == typeof i && i;
            r || (o = e.extend({
            }, e.fn.ace_spinner.defaults, i), t.data('ace_spinner', r = new a(this, o))),
