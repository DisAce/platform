...
var frameTab = {
	...
	*/
	...
	// 判断加载  
	checkComplete : function(appIframe){
		appIframe = Share.hashCode(appIframe);
		appIframe = $.trim(appIframe);
    if ($(window.frames["iframeId"].document).find("#mainFrame_"+appIframe).document.readyState != "complete") {  
    	alert(0);
