			...
			<div id="dv">
				...
				<div class="widget-box transparent">
					<div class="widget-header widget-header-flat">
						<h4 class="lighter">
							<i class="fa fa-list-ol orange"></i> 系统日志列表
						</h4>
...
<script type="text/javascript">
	jQuery(function($) {
		...
		var _colNames = ['ID', '用户名称', '登录IP', '终端标识','日志信息','状态','创建时间' ];
		var _colModel = [ {name : 'id', index : 'id', width : 60, hidden : true,key : true,sorttype : "text", editable : true }, 
						  {name : 'username',index : 'username',width : 90,editable : true,sorttype : "text"}, 
						  {name : 'ip',index : 'ip',width : 100,sorttype : "text",editable : true}, 
						  {name : 'userAgent',index : 'userAgent',width : 150,sorttype : "text",editable : true}, 
						  {name : 'msg',index : 'msg',width : 150,sorttype : "text",editable : true}, 
						  {name : 'status',index : 'status',width : 50,editable : true,formatter: "select", editoptions:{value:"0:成功;1:失败"}}, 
						  {name : 'createTime',index : 'createTime',width : 70,editable : true,edittype : "text"} ];
		T._initDataGrid(grid_selector,pager_selector,"admin/syslog/data",_colNames,_colModel);
	});
</script>
