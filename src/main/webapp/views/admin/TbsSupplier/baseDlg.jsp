<form class="form-horizontal container" id="estype_add_form" action="YWRtaW4vc3VwcGxpZXIvc2F2ZQ"
	...
	<div class="row">
		...
		<div class="col-md-9">
			<input id="obj_name" name="name" type="text" data-rel="tooltip"
				...
				errormsg="名称至少6个字符,最多32个字符！" nullmsg="请输入公司名称"> <span
				class="middle" style="color: red"> *</span>
			<div class="Validform_checktip" style="clear: both;"></div>
		</div>
	</div>
	<div class="row">
	<label for="obj_address" class="col-md-3 control-label no-padding-right"> 公司地址： </label>
		<div class="col-md-9">
			<input id="obj_address" name="address" type="text" data-rel="tooltip"
				class="col-md-10" placeholder="" datatype="*1-32"
				errormsg="地址 长度不能超过32位！" nullmsg="请输入公司地址"> <span
				class="middle" style="color: red"> *</span>
			<div class="Validform_checktip" style="clear: both;"></div>
		</div>
	</div>
