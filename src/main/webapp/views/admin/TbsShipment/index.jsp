			...
			<div class="page-content">
				...
				<div class="widget-box transparent">
					<div class="widget-header widget-header-flat">
						<h4 class="lighter">
							<i class="fa fa-list-ol orange"></i> 出货商管理列表
						</h4>
...
<script type="text/javascript">
	...
	//alert(T.M.encode(T.E.utf16to8('admin/shipment/save'))+"===="+T.E.utf8to16(T.M.decode('YWRtaW4vc2hpcG1lbnQvc2F2ZQ')));
		...
		$('#icon-bureau-add').on( 'click', function(e) {
			...
			T.Box.WSC_ShowDialog("admin/shipment/baseDlg", 400, title);
		...
		$("body").on( 'click',"#btn-ico-confirmation", function(e) {
			e.preventDefault();
			T.U.AjaxRequest({
   					url : T.U.RewriteAjaxAction('admin/shipment/del/'+T.C.S.SKEY),type:"POST",
   					callback : function(data) {
   						   if (typeof (data)  != 'undefined') {
		                    	if(data.success){
		                    		jQuery(T.C.S.DridSelector).jqGrid('setGridParam', {
		            					url : T.U.RewriteAjaxAction('admin/shipment/data'+"?_t=" + new Date().getTime()),
		            					mtype:'POST'
		            				}).trigger("reloadGrid");
		...
		T.D._initDataGrid(grid_selector,pager_selector,"admin/shipment/data",_colNames,_colModel);
